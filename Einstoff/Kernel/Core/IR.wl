...
irConstructors = {
  ...
  Einstoff`Internal`IR`SequenceMemberId,
  Einstoff`Internal`IR`SequenceOccurrence,
  ...
  Einstoff`Internal`IR`EqualSizeExpr,
  ...
  Einstoff`Internal`IR`OperationSpec,
  Einstoff`Internal`IR`Violation,
